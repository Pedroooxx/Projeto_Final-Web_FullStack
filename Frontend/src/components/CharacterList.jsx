...
const CharacterList = () => {
  ...
  return (
    <div className="w-full max-w-[1240px] mx-auto flex flex-col items-center justify-center py-16 text-slate-900 font-sans">
      <div className="pb-8 lg:px-0 sm:px-8">
        ...
        <p className="lg:text-3xl sm:text-lg lg:text-center sm:text-justify">
        ...
        <table className="table-auto w-full">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 text-left hidden lg:table-cell">Casa</th>
          ...
          <tbody>
            {characterList?.map((character) => (
              <tr key={character.id}>
                ...
                <td className="border px-4 py-2 hidden lg:table-cell">{character?.house}</td>
                <td className="border px-4 py-2">{character?.status}</td>
              </tr>
            ))}
          </tbody>
        </table>
